...
namespace CameraController
{
    public partial class MainForm : Form
    {
        ...
        private void OneKeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                bool newValue = !this.enabled;
                
                this.ToggleInGameCamera(newValue);
                ...
                this.statusLabel.Text = this.enabled ? "Enabled" : "Disabled";
                this.resetBtn.Enabled = this.enabled;
        ...
        private void ToggleInGameCamera(bool enable)
        {
            if (enable)
            {
                ...
                {
                    this.memoryManager.WriteBytes(allocatedMem.Value + 0xE, new byte[] { 0x74, 0x28 });
                }
                else
                {
